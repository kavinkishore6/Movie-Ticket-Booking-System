...
public class BookingService {
    ...
    public Booking getBookingById(Long id) {
        return bookingRepository.findById(id)
                .orElseThrow(() ->
                        new GlobalExceptionHandler.BookingNotFoundException(
    ...
    public void generatePdfTicket(Long bookingId, HttpServletResponse response) {
        try {
            ...
            if (show == null || show.getMovie() == null) {
                throw new GlobalExceptionHandler.BookingNotFoundException(
                        "Booking details (Show or Movie) are incomplete."
                );
            }
